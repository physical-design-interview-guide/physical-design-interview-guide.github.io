...
</span></span></span><!--[endif]-->Very tight transition target can cause more
latency, unnecessary buf/inv insertion.<o:p></o:p></p>
...
</span></span></span><!--[endif]--><b>Thumb Rule:</b> A common practice is to
set the clock transition target to be about 10-15% of the clock period as a
starting point, then tighten or loosen it based on power and performance
