...
tool will then build a dedicated, shorter path to balance just those flops.</span></p>
...
</span></span></span><!--[endif]--><b>Apply latency attributes:</b>
set_clock_latency -source -max &lt;delay&gt;, to a specific pin, tricking the
tool into building a shorter path to that point to meet the tighter constraint.<o:p></o:p></p>
